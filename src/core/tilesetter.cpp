...
game::core::Tilesetter::Tilesetter() {
	...
	levels.insert(std::pair<std::string, std::vector<int>>("level1", {
		...
		2,1,5,2,10,		2,4,4,1,9,		9,9,1,9,8,		2,5,6,4,2,1,
		1,3,2,1,5,		2,5,2,1,9,		9,9,3,2,1,		2,5,6,2,1,1,
		2,1,5,2,10,		2,4,4,1,9,		9,9,1,9,8,		2,5,6,4,2,1,
		1,3,2,1,5,		2,5,2,1,9,		9,9,3,2,1,		2,5,6,2,1,1,
		2,1,5,2,10,		2,4,4,1,2,		9,9,1,9,8,		2,5,6,4,2,1,
	...
	levels.insert(std::pair<std::string, std::vector<int>>("level2", {
		...
		2,1,5,2,10,		2,4,4,1,2,		5,2,1,9,8,		2,5,6,4,2,1,
		1,3,2,1,5,		2,5,2,10,10,		10,10,3,2,1,		2,5,6,2,1,1,
		2,1,5,2,10,		2,4,4,10,10,		10,10,1,9,8,		2,5,6,4,2,1,
