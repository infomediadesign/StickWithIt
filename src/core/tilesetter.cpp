...
game::core::Tilesetter::Tilesetter() {
	...
	levels.insert(std::pair<std::string, std::vector<int>>("level2", {
		...
		1,3,2,1,5,		2,5,2,1,4,		1,4,3,2,1,		2,5,6,2,1,
		2,1,5,2,20,		2,4,4,1,2,		5,2,1,9,8,		2,5,6,4,2,
		1,3,2,1,5,		2,5,2,1,20,		1,4,3,2,1,		2,5,6,2,1,

		2,1,5,2,10,		2,4,4,1,2,		5,2,1,9,8,		2,5,6,4,2,
		1,3,2,1,5,		2,5,2,1,4,		1,4,3,2,1,		2,5,6,2,1,
		2,1,5,2,10,		2,4,4,1,2,		5,2,1,9,8,		2,5,6,4,2,
		1,3,2,1,5,		2,5,20,1,4,		1,4,3,2,1,		2,5,6,17,1,
		2,1,5,2,10,		2,4,4,1,2,		5,2,1,9,8,		2,5,6,4,2,

		1,3,2,1,5,		2,5,2,1,4,		1,4,3,2,1,		2,5,6,2,1,
		2,1,5,2,10,		2,4,4,1,2,		5,2,1,9,8,		2,5,6,4,2,
		1,3,2,1,5,		2,5,2,1,4,		1,4,3,2,20,		2,5,6,2,1
	}));
}
	...
	switch (level)
	{
		...
		case 2:
		{
			...
			for (int y = 0; y < amountOfTilesY; y++)
			{
				for (int x = 0; x < amountOfTilesX; x++)
				{
					DrawTexture(*tiles.find(levels.find("level2")->second[positionInTilemap])->second, x * 32 - 16, y * 32, WHITE);
					positionInTilemap++;
				}
			}
			break;
